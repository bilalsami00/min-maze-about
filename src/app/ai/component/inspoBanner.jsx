...
const InspoBanner = ({ title = "", subtitle = "" }) => {
  return (
    <section className=" bg-[#0071F5] text-white  flex flex-col xl:flex-row items-center justify-center">
      <div className="px-6 pt-6  pb-8 md:py-12 md:px-18 2xl:px-0 2xl:w-7xl flex max-xl:justify-center w-full max-xl:flex-wrap gap-6 md:gap-10 xl:gap-42 ">
        ...
        <button className="md:ml-auto txt-18 font-semibold bg-white text-[#0071F5] xl:max-w-[196px] max-h-14 rounded-xl w-full p-4">
          Book a Call
        </button>
      </div>
    </section>
